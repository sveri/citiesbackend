...
open: de.sveri.osm.cities.setup and adapt the driver in `browser-setup` to `:firefor` or `:chrome`.
...
You have to reset the system, by calling `(de.sveri.osm.cities.user/reset)` in the repl.
