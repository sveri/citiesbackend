(ns de.sveri.osm.cities.routes.user
  (:require [compojure.core :refer [routes GET POST]]
            ...
            [de.sveri.osm.cities.views.user :as vh]
            [de.sveri.osm.cities.views.base :as v]
            [de.sveri.osm.cities.db.user :as db]
            [de.sveri.osm.cities.service.auth :as auth]
            [de.sveri.osm.cities.service.user :as uservice])
