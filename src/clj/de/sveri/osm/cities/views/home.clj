(ns de.sveri.osm.cities.views.home
  (:require [de.sveri.osm.cities.views.base :as v]))
...
(defn reagent-example [req]
  (v/render
    "" (merge req {:plain-js "<script src=\"/js/example/example.js\"></script><script type=\"text/javascript\">de.sveri.osm.cities.core.init();</script>"})
    [:div
     [:div#app]]))
