(ns de.sveri.osm.cities.middleware
  (:require [clojure.tools.logging :as log]
            ...
            [de.sveri.osm.cities.locale :as loc]
            [de.sveri.osm.cities.service.auth :refer [auth-backend]]
...
(def development-middleware
  [#(prone/wrap-exceptions % {:app-namespaces ['de.sveri.osm.cities]})
   wrap-reload])
