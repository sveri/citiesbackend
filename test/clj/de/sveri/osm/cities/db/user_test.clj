(ns de.sveri.osm.cities.db.user-test
  (:require [clojure.test :refer :all]
            [clojure.java.jdbc :as j]
            [de.sveri.osm.cities.db.user :as u]))

(def db {:connection-uri "jdbc:postgresql://localhost:5432/citiesbackend_test?user=citiesbackend&password=citiesbackend"})
